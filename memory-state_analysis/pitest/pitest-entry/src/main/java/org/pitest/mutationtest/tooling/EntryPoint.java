...
import static staticfields.pitest.StaticScanner.storeStaticFields;
...
public class EntryPoint {
  ...
  public AnalysisResult execute(File baseDir, ReportOptions data,
    ...
    storeStaticFields(code);
    //initialize MR probes and NMR probes
    ProblemRecorder.initializeMRNMRProbes();
    ProblemRecorder.checkExistsOrCreate("target/test-classes/bytes.txt");
