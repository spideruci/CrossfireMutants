...
public class AudioAnalysisMeasure extends AbstractModelObject {
  ...
  public static final class Builder extends AbstractModelObject.Builder {
    ...
    public AudioAnalysisMeasure build() {
      return new AudioAnalysisMeasure(this); // mutation (46) 285076451
    }
  }
  ...
  public static final class JsonUtil extends AbstractModelObject.JsonUtil<AudioAnalysisMeasure> {
    public AudioAnalysisMeasure createModelObject(JsonObject jsonObject) {
      if (jsonObject == null || jsonObject.isJsonNull()) { // mutation (22) -570104322 // mutation (23) -570104415
        return null;
      }

      return new AudioAnalysisMeasure.Builder() // mutation (18) -420252573 return null;
        .setConfidence(
          hasAndNotNull(jsonObject, "confidence") //  mutation (21) -570103764
            ? jsonObject.get("confidence").getAsFloat()
            : null)
        .setDuration(
          hasAndNotNull(jsonObject, "duration") // mutation (20) -570103051
            ? jsonObject.get("duration").getAsFloat()
            : null)
        .setStart(
          hasAndNotNull(jsonObject, "start") // mutation (19) negated conditional -570102338
