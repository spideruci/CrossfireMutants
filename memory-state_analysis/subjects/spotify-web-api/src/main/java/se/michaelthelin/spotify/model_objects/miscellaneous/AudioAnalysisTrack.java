  ...
  public static final class JsonUtil extends AbstractModelObject.JsonUtil<AudioAnalysisTrack> {
    public AudioAnalysisTrack createModelObject(JsonObject jsonObject) {
      ...
      return new AudioAnalysisTrack.Builder()
        .setAnalysisChannels(
          hasAndNotNull(jsonObject, "analysis_channels") // mutation (45) -645352686
            ? jsonObject.get("analysis_channels").getAsInt()
            : null)
        .setAnalysisSampleRate(
          hasAndNotNull(jsonObject, "analysis_sample_rate") // mutation (44) -645351973
        ...
        .setCodeString(
          hasAndNotNull(jsonObject, "code_string")
            ...
            : null)
        .setCodeVersion(
          hasAndNotNull(jsonObject, "code_version") // mutation (43) -645350578
            ? jsonObject.get("code_version").getAsFloat()
            : null)
        .setDuration(
          hasAndNotNull(jsonObject, "duration") // mutation (42) -645349865
            ? jsonObject.get("duration").getAsFloat()
            : null)
        .setEchoprintString(
          hasAndNotNull(jsonObject, "echoprintstring") // mutation (41) -645349152
            ? jsonObject.get("echoprintstring").getAsString()
            : null)
        .setEchoprintVersion(
          hasAndNotNull(jsonObject, "echoprint_version") // mutation (40) -645348470
        ...
        .setEndOfFadeIn(
          hasAndNotNull(jsonObject, "end_of_face_in")
            ...
            : null)
        .setKey(
          hasAndNotNull(jsonObject, "key") // mutation (39） -645347044
            ? jsonObject.get("key").getAsInt()
            : null)
        .setKeyConfidence(
          hasAndNotNull(jsonObject, "key_confidence") // mutation (38) -645346331
            ? jsonObject.get("key_confidence").getAsFloat()
            : null)
        .setLoudness(
          hasAndNotNull(jsonObject, "loudness") // mutation (37) -645345618
        ...
        .setMode(
          hasAndNotNull(jsonObject, "mode")
            ...
            : null)
        .setModeConfidence(
          hasAndNotNull(jsonObject, "mode_confidence") // mutation (36) '-645344068
            ? jsonObject.get("mode_confidence").getAsFloat()
            : null)
        .setNumSamples(
          hasAndNotNull(jsonObject, "num_samples")// mutation (35) '-645343355',
            ? jsonObject.get("num_samples").getAsLong()
            : null)
        .setOffsetSeconds(
          hasAndNotNull(jsonObject, "offset_seconds")// mutation (34) '-645342642',
            ? jsonObject.get("offset_seconds").getAsInt()
            : null)
        .setRhythmString(
          hasAndNotNull(jsonObject, "rhythmstring") // // mutation (33) '-645341929',
            ? jsonObject.get("rhythmstring").getAsString()
            : null)
        .setRhythmVersion(
          hasAndNotNull(jsonObject, "rhythm_version") // mutation (32) '-645341247'
            ? jsonObject.get("rhythm_version").getAsFloat()
            : null)
        .setSampleMd5(
          hasAndNotNull(jsonObject, "sample_md5") // mutation (31) -645340534
            ? jsonObject.get("sample_md5").getAsString()
            : null)
        .setStartOfFadeOut(
          hasAndNotNull(jsonObject, "start_of_fade_out") // mutation (30) -645339852
            ? jsonObject.get("start_of_fade_out").getAsFloat()
            : null)
        .setSynchString(
          hasAndNotNull(jsonObject, "synchstring") //mutation (29) -645339139
            ? jsonObject.get("synchstring").getAsString()
            : null)
        .setSynchVersion(
          hasAndNotNull(jsonObject, "synch_version") // mutation (28) -645338457
            ? jsonObject.get("synch_version").getAsFloat()
            : null)
        .setTempo(
          hasAndNotNull(jsonObject, "tempo") // mutation (27) -645337744
            ? jsonObject.get("tempo").getAsFloat()
            : null)
        .setTempoConfidence(
          hasAndNotNull(jsonObject, "tempo_confidence") // mutation (26) -645337031
            ? jsonObject.get("tempo_confidence").getAsFloat()
            : null)
        .setTimeSignature(
          hasAndNotNull(jsonObject, "time_signature") // mutation (25) -645336318
            ? jsonObject.get("time_signature").getAsInt()
            : null)
        .setTimeSignatureConfidence(
          hasAndNotNull(jsonObject, "time_signature_confidence") // mutation (24) -645335605
