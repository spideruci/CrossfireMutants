...
public class InstrumentationUtils {
    ...
    public static void clearStatic()  {
        ...
        MoneyAmountStyle.LOCALIZED_CACHE = new ConcurrentHashMap<Locale, MoneyAmountStyle>();
        CurrencyUnit.currenciesByCode = new ConcurrentSkipListMap<String, CurrencyUnit>();
        /**
         * Map of registered currencies by numeric code.
         */
        CurrencyUnit.currenciesByNumericCode = new ConcurrentHashMap<Integer, CurrencyUnit>();
        /**
         * Map of registered currencies by country.
         */
        CurrencyUnit.currenciesByCountry = new ConcurrentSkipListMap<String, CurrencyUnit>();
