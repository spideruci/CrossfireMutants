...
//    @Parameters(name = "{0}")
    public static Stream<Arguments> data() {
        ...
        return list.stream().map(x -> Arguments.of(x));
    }

    private DigestUtilsTest digestUtilsTest;

    private HmacAlgorithms hmacAlgorithm;

    private byte[] standardResultBytes;
    private String standardResultString;

    public HmacAlgorithmsTest() {
    ...
    @ParameterizedTest
    @MethodSource("data")
    public void testHmacFailInputStream(final HmacAlgorithms hmacAlgorithm, final byte[] standardResultBytes, final String standardResultString) throws IOException {
        Assume.assumeTrue(HmacUtils.isAvailable(hmacAlgorithm));
        this.hmacAlgorithm = hmacAlgorithm;
        this.standardResultBytes = standardResultBytes;
        this.standardResultString = standardResultString;
    ...
    @ParameterizedTest
    @MethodSource("data")
    public void testHmacHexFailInputStream(final HmacAlgorithms hmacAlgorithm, final byte[] standardResultBytes, final String standardResultString) throws IOException {
        Assume.assumeTrue(HmacUtils.isAvailable(hmacAlgorithm));
        this.hmacAlgorithm = hmacAlgorithm;
        this.standardResultBytes = standardResultBytes;
        this.standardResultString = standardResultString;
