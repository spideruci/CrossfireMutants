...
public class Assert {
    ...
    /** @deprecated
     * it returns nothing in our implementation */
    @Deprecated
    public static <T> void assertThat(String reason, T actual, Matcher<? super T> matcher,String location) {
        Runnable runnable = () -> org.junit.Assert.assertThat(reason, actual, matcher);
