...
public class Assertions {
    ...
    public static void assertTimeout(Duration timeout, Executable executable, String location) {
        Runnable runnable = () -> org.junit.jupiter.api.Assertions.assertTimeout(timeout, executable);
        runOldAssertion(runnable, location);
    }

    public static void assertTimeout(Duration timeout, Executable executable, String message, String location) {
        Runnable runnable = () -> org.junit.jupiter.api.Assertions.assertTimeout(timeout, executable, message);
        runOldAssertion(runnable, location);
    }

    public static void assertTimeout(Duration timeout, Executable executable, Supplier<String> messageSupplier, String location) {
        Runnable runnable = () -> org.junit.jupiter.api.Assertions.assertTimeout(timeout, executable, messageSupplier);
        runOldAssertion(runnable, location);
    }
