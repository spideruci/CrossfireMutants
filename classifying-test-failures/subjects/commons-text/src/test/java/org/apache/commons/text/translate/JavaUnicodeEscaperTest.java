...
public class JavaUnicodeEscaperTest {
    ...
    public void testAbove() {
        ...
        ProxyAssertions.customized.Customized.runAssertion(() -> {assertThat(result).as("Failed to escape Unicode characters via the above method")
            .isEqualTo("ADF\\u0047\\u005A");});
    }
    ...
    public void testBelow() {
        ...
        final String input = "ADFGZ";
        final String result = jue.translate(input);
        ProxyAssertions.customized.Customized.runAssertion(() -> {assertThat(result).as("Failed to escape Unicode characters via the below method")
            .isEqualTo("\\u0041\\u0044FGZ");});
    }
    ...
    public void testBetween() {
        ...
        final String input = "ADFGZ";
        final String result = jue.translate(input);
        ProxyAssertions.customized.Customized.runAssertion(() -> {assertThat(result).as("Failed to escape Unicode characters via the between method")
            .isEqualTo("AD\\u0046\\u0047Z");});
    }
    ...
    public void testToUtf16Escape() {
        ...
        ProxyAssertions.customized.Customized.runAssertion(() -> {assertThat(encoding).isEqualTo("\\uD852\\uDF62");});
    }
}
