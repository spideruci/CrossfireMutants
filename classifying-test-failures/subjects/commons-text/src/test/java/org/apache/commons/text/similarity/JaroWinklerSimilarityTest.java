...
public class JaroWinklerSimilarityTest {
    ...
    public void testGetJaroWinklerSimilarity_NullNull() {
        ProxyAssertions.customized.Customized.runAssertion(() -> {assertThatIllegalArgumentException().isThrownBy(() -> similarity.apply(null, null));});
    }

    @Test
    public void testGetJaroWinklerSimilarity_NullString() {
        ProxyAssertions.customized.Customized.runAssertion(() -> {assertThatIllegalArgumentException().isThrownBy(() -> similarity.apply(null, "clear"));});
    }

    @Test
    public void testGetJaroWinklerSimilarity_StringNull() {
        ProxyAssertions.customized.Customized.runAssertion(() -> {assertThatIllegalArgumentException().isThrownBy(() -> similarity.apply(" ", null));});
    }
