...
public class CsvTranslatorsTest {
    ...
    public void csvEscaperCommaTest() throws IOException {
        ...
        ProxyAssertions.customized.Customized.runAssertion(() -> {assertThat(data).isEqualTo("\"hi,this,is,a,test\"");});
    }
    ...
    public void csvEscaperCRTest() throws IOException {
        ...
        escaper.translateWhole(input, writer);
        final String data = writer.toString();
        ProxyAssertions.customized.Customized.runAssertion(() -> {assertThat(data).isEqualTo("\"hi,this,is,a,CR,test" + String.valueOf(CharUtils.CR) + "\"");});
    }
    ...
    public void csvEscaperLFTest() throws IOException {
        ...
        escaper.translateWhole(input, writer);
        final String data = writer.toString();
        ProxyAssertions.customized.Customized.runAssertion(() -> {assertThat(data).isEqualTo("\"hi,this,is,a,LF,test" + String.valueOf(CharUtils.LF) + "\"");});
    }
    ...
    public void csvEscaperPlaneTextTest() throws IOException {
        ...
        escaper.translateWhole(input, writer);
        final String data = writer.toString();
        ProxyAssertions.customized.Customized.runAssertion(() -> {assertThat(input).isEqualTo(data);});
    }
    ...
    public void csvEscaperQuoteTest() throws IOException {
        ...
        escaper.translateWhole(input, writer);
        final String data = writer.toString();
        ProxyAssertions.customized.Customized.runAssertion(() -> {assertThat(data).isEqualTo("\"hi,this,is,a,\"\"quote,test\"");});
    }
    ...
    public void csvUnEscaperPlaneTextTest() throws IOException {
        ...
        escaper.translateWhole(input, writer);
        final String data = writer.toString();
        ProxyAssertions.customized.Customized.runAssertion(() -> {assertThat(data).isEqualTo("hi,this,is,unescape,test");});
    }
