...
public class JaroWinklerDistanceTest {
    ...
    public void testGetJaroWinklerDistance_NullNull() {
        ProxyAssertions.customized.Customized.runAssertion(() -> {assertThatIllegalArgumentException().isThrownBy(() -> distance.apply(null, null));});
    }

    @Test
    public void testGetJaroWinklerDistance_NullString() {
        ProxyAssertions.customized.Customized.runAssertion(() -> { assertThatIllegalArgumentException().isThrownBy(() -> distance.apply(null, "clear"));});
    }
