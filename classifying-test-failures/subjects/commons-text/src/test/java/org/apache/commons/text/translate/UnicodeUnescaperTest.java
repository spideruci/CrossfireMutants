...
public class UnicodeUnescaperTest {
    ...
    public void testUPlus() {
        ...
        ProxyAssertions.customized.Customized.runAssertion(() -> {assertThat(uu.translate(input)).as("Failed to unescape Unicode characters with 'u+' notation").isEqualTo("G");});
    }
    ...
    public void testUuuuu() {
        ...
        ProxyAssertions.customized.Customized.runAssertion(() -> {assertThat(result).as("Failed to unescape Unicode characters with many 'u' characters").isEqualTo("G");});
    }
}
