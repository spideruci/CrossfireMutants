...
public class JaccardDistanceTest {
    ...
    public void testGettingJaccardDistanceNullNull() {
        ProxyAssertions.customized.Customized.runAssertion(() -> {assertThatIllegalArgumentException().isThrownBy(() -> classBeingTested.apply(null, null));});
    }

    @Test
    public void testGettingJaccardDistanceNullString() {
        ProxyAssertions.customized.Customized.runAssertion(() -> {assertThatIllegalArgumentException().isThrownBy(() -> classBeingTested.apply(null, "right"));});
    }

    @Test
    public void testGettingJaccardDistanceStringNull() {
        ProxyAssertions.customized.Customized.runAssertion(() -> {assertThatIllegalArgumentException().isThrownBy(() -> classBeingTested.apply(" ", null));});
    }
}
