...
public class LevenshteinResultsTest {
    ...
    public void testEqualsDifferenceInSubstitutionCount() {
        ...
        ProxyAssertions.customized.Customized.runAssertion(() -> {assertThat(levenshteinResults.equals(levenshteinResultsTwo)).isFalse();});
    }
    ...
    public void testEqualsSameObject() {
        ...
        ProxyAssertions.customized.Customized.runAssertion(() -> {assertThat(levenshteinResults.equals(levenshteinResults)).isTrue();});
    }
    ...
    public void testEqualsWithNull() {
        ...
        ProxyAssertions.customized.Customized.runAssertion(() -> {assertThat(levenshteinResults.equals(null)).isFalse();});
    }
