...
public class TestMoneyFormatterBuilder {
    ...
    //-----------------------------------------------------------------------
//    @DataProvider
    public static Stream<Arguments> data_appendAmount() {
...
//    @DataProvider
    ...
    public static Stream<Arguments> data_appendAmountLocalized() {
        return Arrays.stream(new Object[][] {
...
//    @DataProvider
    public static Stream<Arguments> data_appendAmount_MoneyAmountStyle() {
    ...
    //-----------------------------------------------------------------------
//    @DataProvider
    public static Stream<Arguments> data_appendAmountExtendedGrouping() {
        return Arrays.stream(new Object[][] {
            {GBP_2_34, "2.34"},
            {GBP_23_45, "23.45"},
            {GBP_234_56, "234.56"},
